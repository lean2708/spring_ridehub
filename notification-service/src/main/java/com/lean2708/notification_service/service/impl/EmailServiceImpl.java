...
import com.lean2708.notification_service.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    @KafkaListener(topics = "email-register", groupId = "ridehub-email-register-group")
    public void sendOtpRegisterEmail(EmailEvent event) throws IOException {
        ...
        dynamicData.put("otp", event.getOtp());
    ...
    public void sendPasswordResetCode(EmailEvent event) throws IOException {
        ...
        Map<String, String> dynamicData = new HashMap<>();
        dynamicData.put("name", event.getName());
        dynamicData.put("verificationCode", event.getOtp());
